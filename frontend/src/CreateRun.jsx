...
export default function CreateRun({ onCreated, onCancel }) {
    ...
    return (
        <div style={{ maxWidth: 560, margin: "0 auto" }}>
            ...
            <div style={ROW}>
                <label style={LABEL}>defect placement</label>
                <textarea style={{ ...FIELD, minHeight: 48, resize: "vertical" }} value={placement}
                    onChange={(e) => setPlacement(e.target.value)}
                    placeholder="where should defects sit? e.g. the defect should be localised to a via" />
                <div className="muted" style={{ fontSize: 11, marginTop: 4 }}>
                    free text — the agent combines this with what it sees in the image to pick the target feature.
                </div>
            </div>
